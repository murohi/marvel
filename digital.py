...
import os
#動画ファイルを読み込む
file_name = 'images/WIN_20190717_14_12_24_Pro.mp4'
...
#画像の輝度値をyにいれる
x = np.arange(0,93)
y = [im0.mean(),im1.mean(),im2.mean(),im3.mean(),im4.mean(),im5.mean(),im6.mean(),im7.mean(),im8.mean(),im9.mean(),im10.mean(),im11.mean(),im12.mean(),
     im13.mean(),im14.mean(),im15.mean(),im16.mean(),im17.mean(),im18.mean(),im19.mean(),im20.mean(),im21.mean(),im22.mean(),im23.mean(),im24.mean(),
     im25.mean(),im26.mean(),im27.mean(),im28.mean(),im29.mean(),im30.mean(),im31.mean(),im32.mean(),im33.mean(),im34.mean(),im35.mean(),im36.mean(),
     im37.mean(),im38.mean(),im39.mean(),im40.mean(),im41.mean(),im42.mean(),im43.mean(),im44.mean(),im45.mean(),im46.mean(),im47.mean(),im48.mean(),
     im49.mean(),im50.mean(),im51.mean(),im52.mean(),im53.mean(),im54.mean(),im55.mean(),im56.mean(),im57.mean(),im58.mean(),im59.mean(),im60.mean(),
     im61.mean(),im62.mean(),im63.mean(),im64.mean(),im65.mean(),im66.mean(),im67.mean(),im68.mean(),im69.mean(),im70.mean(),im71.mean(),im72.mean(),
     im73.mean(),im74.mean(),im75.mean(),im76.mean(),im77.mean(),im78.mean(),im79.mean(),im80.mean(),im81.mean(),im82.mean(),im83.mean(),im84.mean(),
     im85.mean(),im86.mean(),im87.mean(),im88.mean(),im89.mean(),im90.mean(),im91.mean(),im92.mean()]
